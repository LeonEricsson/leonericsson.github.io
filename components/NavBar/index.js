...
export default function NavBar() {
  ...
  const NavLink = ({ href, children }) => {
    ...
    return (
      <Link
        href={href}
        className={`inline-flex items-center px-4 pt-8 pb-3 text-base font-cardo italic text-deep-charcoal transition-all duration-300 ${
            ...
            <div className="flex h-20 justify-center items-center">
              <div className="hidden items-center md:flex md:space-x-12">
                ...
                <a
                  ...
                  className="inline-flex items-center px-4 pt-8 pb-3 text-base font-cardo italic text-deep-charcoal hover:text-sepia-accent transition-all duration-300"
                >
                  work
                </a>
              </div>
          ...
          <Disclosure.Panel className="md:hidden bg-warm-cream">
            <div className="space-y-1 pt-2 pb-3">
              <Disclosure.Button
                as={Link}
                href="/"
                className="block border-l-2 border-subtle-line py-3 pl-4 pr-4 text-sm font-cardo italic text-deep-charcoal hover:bg-vintage-paper hover:border-sepia-accent transition-all duration-300"
              >
                Home
              </Disclosure.Button>
              <Disclosure.Button
